...
INNER JOIN job_mart.staging.priority_roles AS r
    ON jpf.job_title_short = r.role_name;

-- UPDATE Statement
-- UPDATE job_mart.main.priority_jobs_snapshot AS tgt
-- SET 
...
-- WHERE NOT EXISTS (
--     SELECT 1
--     FROM job_mart.main.priority_jobs_snapshot AS tgt
--     WHERE tgt.job_id = src.job_id
-- );

-- -- DELETE Statement
-- DELETE FROM job_mart.main.priority_jobs_snapshot AS tgt
-- WHERE NOT EXISTS (
--     SELECT 1
--     FROM src_priority_jobs AS src
